...
-->
    ...
    <link rel="stylesheet" href="{{ asset('website')}}/css/templatemo-style.css">                                   <!-- Templatemo style -->
                    ...
                    <nav class="navbar tm-main-nav">
                        ...
                        <div class="collapse navbar-toggleable-sm" id="tmNavbar">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('login') }}" class="nav-link">Blog</a>
                                </li>
                                <li class="nav-item">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                        ...
                        <div class="tm-footer-content-box">
                            ...
                            <div class="tm-margin-b-30">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-1.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-2.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-3.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-4.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-5.jpg" alt="Image" class="tm-footer-thumbnail">
                                <img src="{{ asset('website')}}/img/tm-img-100x100-6.jpg" alt="Image" class="tm-footer-thumbnail">
                            </div>
