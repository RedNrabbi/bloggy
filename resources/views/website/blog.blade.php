                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-9 col-xl-9">
                        <div class="tm-blog-post">
                            ...
                            <img src="{{ asset('website')}}/img/tm-img-1010x336-1.jpg" alt="Image" class="img-fluid tm-img-post">
                        ...
                        <div class="row tm-margin-t-big">
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <div class="tm-content-box">
                                    <img src="{{ asset('website')}}/img/tm-img-310x180-1.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <div class="tm-content-box">
                                    <img src="{{ asset('website')}}/img/tm-img-310x180-2.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                ...
                                <div class="tm-content-box">
                                    <img src="{{ asset('website')}}/img/tm-img-310x180-3.jpg" alt="Image" class="tm-margin-b-30 img-fluid">
